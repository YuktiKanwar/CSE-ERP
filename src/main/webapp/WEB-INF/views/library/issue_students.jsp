...
<div class="container-fluid">
	<div class="container">
	<div class="col-md-12"><h2>Book</h2></div>
	<div class="col-md-4"><p> Title : ${book.title} </p></div>
	<div class="col-md-4"><p> Description : ${book.desc} </p></div>
	</div>
	<br>
	<h3>Students List</h3>
	<c:if test="${!empty studentList}">
		<table class="mdl-data-table row-border hover" id="student_list">
			...
			<tr>
				...
				<td><a href="<c:url value='${book.id}/${student.id}'/>"><button class="btn btn-sm btn-warning">Issue</button></a></td>
			</tr>
		</c:forEach>
		</table>
	</c:if>
